pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://65.2.175.78:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/KvnBalaji4/practicle3.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://65.2.175.78:9090/springapp1"
            echo "✅ Frontend deployed: http://65.2.175.78:9090/frontapp1"
        }
        failure {
